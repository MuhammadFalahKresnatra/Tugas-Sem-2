...
$('#allpelanggan').click(function (e) { 
    ...
    $.ajax({
        ...
        success: function (response) {
            // console.log(response);
            let out = '<table class="table mt-4"><thead><tr><th scope="col">ID</th><th scope="col">Pelanggan</th><th scope="col">Alamat</th><th scope="col">Telp</th><th scope="col">Update</th><th scope="col">Delete</th></tr></thead><tbody>';
